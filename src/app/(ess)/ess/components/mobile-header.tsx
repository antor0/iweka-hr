...
export function MobileHeader({ title, subtitle, showBack, rightAction }: MobileHeaderProps) {
    ...
    return (
        <div className="flex flex-col w-full relative">
            {/* Unified Top Navigation Bar (covers safe area + 44px bar) */}
            <div
                className={`fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] z-[100] transition-colors duration-300 ${
                    scrolled
